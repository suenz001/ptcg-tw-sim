 ...
 * v6.193 曾把港版重複收錄的兩筆（18965／18969）刪掉；v6.194 依站長改判**放回資料裡**，
 *   改成「下架」——卡片仍在卡池（回放／比賽紀錄要用），只是玩家在卡牌資料庫與牌組編輯器
 *   選不到，見 `$lib/cards/visibility`。台版是古歷 (id=18564)／超級妖火紅狐ex (id=18560)。
 *   ⚠ 這裡的註冊是**卡名**為 key，與 id 無關，上述任何一種處置都不影響本檔任何一行程式。
 */
