  ...
  <section class="changelog-section">
    ...
    <div class="changelog-list">
      ...
      <details>
        ...
        <ul>
          <li>「火人加農炮」「暗算」打對手備戰寶可夢的傷害，先前沒有檢查備戰免疫（花之帷幔、球形盾牌、太晶、對戰圓形等），會打到本該免疫的寶可夢；「幻影碎」放傷害指示物也漏檢查招式效果免疫（化隱、純樸等）。已把這三招併入 v5.385 的統一傷害結算流程，正確套用免疫；一般情況傷害不變（已用回歸測試網與 harness 逐項驗證）。</li>
        </ul>
      </details>
