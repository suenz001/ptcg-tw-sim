...
<details open>
        <summary><span class="ver-badge">v5.506</span> 對戰修正：「古舊能量」的減 1 獎賞效果（附有它的寶可夢「受到對手寶可夢招式的傷害」而昏厥時，對手少取 1 張獎賞卡）原本連「招式效果造成的昏厥」也會誤觸發。例如被「多龍巴魯托ex｜幻影奇襲」放置的 6 個傷害指示物擊倒、或被招式效果擊倒時，依卡面只限「傷害」昏厥，不應觸發。現已修正：只有受到招式「傷害」而昏厥才減 1，被指示物／效果擊倒不再誤減。卡面同樣寫「受到招式傷害而昏厥」的「莉莉艾的珍珠」「豪華斗篷」一併修正。</summary>
      </details>
