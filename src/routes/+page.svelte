...
<main>
  ...
  <section class="changelog-section">
    ...
    <div class="changelog-list">
      ...
      <details open>
        <summary><span class="ver-badge">v5.270</span> 狙擊備戰招式 audit log + 毒電嬰呼朋引伴選項修正</summary>
        <ul>
          <li>修正：毒電嬰「呼朋引伴」備戰已有 4 隻寶可夢（還能放 1 隻）時，部分裝置上選了基礎寶可夢卻無法確認的問題。現在牌庫有可選基礎寶可夢時，會強制至少選 1 隻；牌庫沒有可選的基礎寶可夢時，直接寫入戰鬥訊息跳過，不再彈出空 picker。</li>
          <li>增強：「剎那斬」「跳踢」「巨石踢」「魯莽踢」「冰之射擊」「瞄準俯衝」等狙擊對手 1 隻備戰的招式，戰鬥訊息現在會明確顯示「✋ 受到 XX 保護不受傷害」或「🎯 對 XX 造成 N 點傷害」，方便對帳花之帷幔／球形盾牌／藏隱／深度下潛／羽毛化石／太晶等備戰免傷效果是否正確觸發。</li>
        </ul>
      </details>
