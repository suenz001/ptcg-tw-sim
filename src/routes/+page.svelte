...
<details open>
        <summary><span class="ver-badge">v5.466</span> 改善線上同步：取消「取得獎賞卡」按鈕——寶可夢被擊倒時，獎賞卡現在會自動進入攻擊方手牌（蓋著的獎賞卡本來就是隨機，自動拿與手動選結果相同）。這能大幅減少「攻擊方取獎賞與防守方換上新寶可夢的時間點重疊」造成的線上卡住／不同步（例如多龍巴魯托ex「幻影奇襲」一次擊倒戰鬥場＋備戰多隻時最容易發生）。含羞苞、咒詛炸彈、過度放電等自損擊倒也一樣自動讓對方獲得獎賞。每次取得獎賞卡都會在對戰紀錄留下記錄——本人看得到剛拿到哪幾張卡、對手只看到張數，方便沒有按鈕後仍能確認獲得的獎賞。</summary>
      </details>
