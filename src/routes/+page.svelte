...
<main>
  ...
  <section class="changelog-section">
    ...
    <div class="changelog-list">
      ...
      <details open>
        <summary><span class="ver-badge">v5.343</span> 修正薄霧能量未擋下「緊抓」等招式的無法撤退效果</summary>
        <ul>
          <li>修正：附有薄霧能量的寶可夢「不會受到對手寶可夢招式的效果的影響」，因此被伊裴爾塔爾的「緊抓」（以及其他造成「下回合無法撤退」的招式，如各種束縛、毒陣等）攻擊時，不該被鎖住無法撤退。原本只有部分招式有正確判定，現在已統一修正——附薄霧能量的寶可夢仍會受到傷害，但不會被招式的「無法撤退」效果影響。</li>
        </ul>
      </details>
