...
<details open>
      ...
      <details>
        <summary><span class="ver-badge">v5.834</span> 對戰修正：由於特殊狀態改為三格制（可同時有 睡眠/混亂/麻痺 之一 ＋ 中毒 ＋ 灼傷），部分「讀取對手特殊狀態」的招式只檢查前一～兩格、漏掉第三格。已收斂為統一的跨三格讀取並修正：搖籃百合「瘴氣之風」、火箭隊的臭臭泥「毒液危害」（依對手特殊狀態『數量』×100，先前少算）；熔岩蟲「炙燒」、晶光花「毒液衝擊」等「若對手處於【灼傷／中毒】則增傷」（該狀態落在第三格時先前會漏判）；青木的姆克鷹「硬撐」（依自身狀態，同理）。</summary>
      </details>
      <details>
        <summary><span class="ver-badge">v5.833</span> 對戰修正：怖納噬草「強力尖刺」（擲與這隻寶可夢身上附加能量數相同次數的硬幣，正面數×80 傷害）先前用「能量卡張數」計算擲幣次數，導致火箭隊能量（1 張＝2 個能量）、燃火能量（附於進化寶可夢＝3 個）等特殊能量少擲硬幣；現已改為依「能量個數」計算，與光電傘蜥「強大伏特」、青木的土龍節節ex「職務猛攻」等同類招式一致。</summary>
      </details>
      <details>
        <summary><span class="ver-badge">v5.832</span> 對戰修正：護城龍「太古防壁」（在備戰區時，自己的所有寶可夢不會受到附加能量 2 個以下的對手寶可夢招式的傷害）先前對「打擊對手全體備戰」類招式（如電飛鼠『天空波』、古鼎鹿『大地斷裂』）漏判——這類招式走另一條傷害管線、沒檢查攻擊方能量數，導致只有 2 顆能量的對手仍能打傷你的備戰寶可夢。現已把太古防壁判定收斂為單一中央述詞，戰鬥場主傷害、狙擊、打全體備戰等所有招式傷害路徑一致套用（能量數依攻擊宣告時計算，特殊能量如火箭隊能量算 2 個）。</summary>
      </details>
      <details>
        <summary><span class="ver-badge">v5.831</span> 對戰修正：夢妖魔ex「漩渦言靈」（在戰鬥場上時，對手回合中對手的戰鬥寶可夢回到備戰區時，讓新上場的寶可夢陷入混亂）先前只在對手「撤退」時觸發；當對手改用招式自我互換（如「與備戰互換」效果、逆向噴射等）或交替類效果讓戰鬥寶可夢回到備戰區時不會觸發。現已收斂為所有「戰鬥寶可夢回到備戰區」的路徑都會觸發（熔岩地域的灼傷、凹洞的放置傷害指示物為同機制，一併修正）。</summary>
      </details>
      <details>
      ...
      <details>
        <summary><span class="ver-badge">v5.803</span> 對戰修正：捲捲耳「撒嬌」、布撥「叫聲」、象徵鳥「反射壁」、赫普的稚山雀「恐怖視線」等讓「對手下次招式傷害-N」的招式，現在會正確尊重對手免疫（如「化隱」特性：不受對手招式與特性的效果影響）——先前無視免疫直接套用</summary>
        <ul>
      ...
      <details>
        <summary><span class="ver-badge">v5.802</span> 對戰修正：流氓鱷ex「窮追不捨」、赫普的朽木妖「窮追不捨」、烈箭鷹「緊抓」等讓「對手下回合無法撤退」的招式，現在會正確尊重對手的免疫（如「化隱」特性：不受對手招式與特性的效果影響）——先前這幾張會無視免疫直接套用</summary>
        <ul>
      ...
      <details>
        <summary><span class="ver-badge">v5.801</span> 對戰修正（延續上版）：浮潛鼬「潮旋」、瑪俐的滑滑小子「咬碎」、火箭隊的班基拉斯「打穿衝撞」、勾帕路翁「神聖刀鋒」也補上「玩家自選要丟哪張對手能量」與免疫判定（先前這幾張走到另一份舊程式漏修）；鴨寶寶「消火」（選擇1個對手【火】能量丟棄）現在會把「古舊能量」等視為【火】的能量也算進去，並補上免疫判定</summary>
        <ul>
          <li>收斂：移除一份重複的舊「丟對手能量」程式，全部統一走同一份（picker＋免疫＋古舊等特殊能量判定）</li>
        </ul>
      </details>
      ...
      <details>
        <summary><span class="ver-badge">v5.797</span> 對戰修正：天蠍王「毒陣」、火箭隊的尼多王ex「惡劣角擊」、鴨嘴炎獸「灼燒」這幾招對對手附加【中毒】／【灼傷】時，現在會正確尊重對手的狀態免疫（例如「祭典會場」在場且對手寶可夢身上有能量、化隱、泡沫【水】能量等）——先前這三招會直接寫入狀態、無視免疫</summary>
        <ul>
          <li>修法：改走中央施狀態管線（與其他施狀態招式一致，統一檢查化隱／憨憨臉／特殊能量／祭典會場等免疫）</li>
        </ul>
      </details>

      <details>
        <summary><span class="ver-badge">v5.796</span> 對戰修正：用「神奇糖果」讓基礎寶可夢直接進化成 2 階寶可夢後，該寶可夢的特性／選目標現在能正常使用了——先前神奇糖果進化會讓場上那隻寶可夢換成手牌卡的內部編號，導致點不開特性（例：夜巡靈用神奇糖果進化成黑夜魔靈後，特性「咒詛炸彈」無法使用）。一般進化不受影響</summary>
        <ul>
          <li>修法：神奇糖果進化改走與一般進化相同的中央建構，保留場上寶可夢的穩定身份編號（iid）</li>
        </ul>
      </details>

      <details>
        <summary><span class="ver-badge">v5.795</span> 對戰修正：櫻花魚「漸強波」（造成這隻寶可夢身上【水】能量數量×30）現在會把「古舊能量」等「視為提供該屬性」的特殊能量正確算進去——先前只認列基本水能量，附「古舊能量」時會少算傷害（例：只附1張古舊能量時原本算0、現在正確算1×30）。同步移除哥達鴨「水炮」一份重複的舊計數死碼（實際生效版本本來就已正確）</summary>
        <ul>
          <li>收斂：依【X】能量數量算傷害一律走中央 host-aware 計數（與大多數同類招式一致）</li>
        </ul>
      </details>
      ...
      <details>
        <summary><span class="ver-badge">v5.789</span> 對戰修正：探探鼠「監視之眼」（雙方寶可夢身上的傷害指示物無法改放）現在也會擋下「招式型」的指示物移動（九尾「九尾狐搬動」、死神棺「伸長的傷害棺材」、振翼髮「蠱惑挪移」、勾魂眼「傷害集結」、火箭隊的果然翁「火箭鏡面」、胡地「奇異駭入」）——先前只擋特性、漏擋這些招式</summary>
        <ul>
          <li>卡面「雙方的所有寶可夢身上放置的傷害指示物，無法改放於其他寶可夢身上」適用於任何來源，原本只在特性端攔截。</li>
        </ul>
      </details>
      ...
      <details>
        ...
        <ul>
          ...
          <li>內部：強化反模式守衛，連「自動治癒」別名呼叫也會檢查是否漏接對手反應，避免日後同類漏網。</li>
        </ul>
      </details>

      <details>
        <summary><span class="ver-badge">v5.781</span> 對戰修正：仙子伊布「奧密迴旋」、甜甜螢「慢芬香」、狡猾天狗「驅趕龍捲風／陣風返」這些「將對手寶可夢與附加的卡放回對手牌庫」的招式，現在會把該寶可夢身上『所有』道具一併放回牌庫（先前只放回 1 張，對「多重轉接」附 2 張道具的洛托姆ex 會漏放，造成額外道具卡遺失）</summary>
        <ul>
          <li>依官方裁定：「與附加的卡全部放回牌庫」包含透過多重轉接附加的額外寶可夢道具。</li>
          <li>內部收斂：自身／對手寶可夢回牌庫一律走中央處理，避免日後同類漏網。</li>
        </ul>
      </details>
...
<details>
        ...
        <ul>
          ...
          <li>麻痺也會在該解除的時機正確解除（先前在這種情況下可能會多麻痺一個回合）。</li>
        </ul>
      </details>

<details>
        <summary><span class="ver-badge">v5.758</span> M5 卡名校正：將戰鬥紀錄中部分 M5 招式／特性的顯示名，統一為台灣官方正式名稱（例如「光子密碼」→「光子纜線」、「烈焰軍團」→「火焰軍團」、「招式竊賊」→「技能大盜」等約 30 張卡），並修正備戰區已滿時的按鈕判定</summary>
        <ul>
          <li>燈火幽靈「亮光增長」、下石鳥「親送挑戰」這類「把寶可夢放到備戰區」的招式，先前在備戰區已滿時按鈕沒有正確變灰（實際放置本來就有上限保護，不會超放，但按鈕判定漏了官方招式名）；現已補上。</li>
          <li>純屬顯示與按鈕判定的名稱校正，不影響任何招式的實際效果或數值。</li>
        </ul>
      </details>
...
<details>
        ...
        <ul>
          ...
          <li>涵蓋桃歹郎「最後鎖鏈」、願增猿ex「鬆口氣」、密勒頓「光子纜線」等被擊倒觸發特性。</li>
        </ul>
      </details>
...
<details>
      ...
      <details open>
        <summary><span class="ver-badge">v5.752</span> 錦標賽：大廳聊天室改為「只載入最新訊息、往上滑再載入更舊」（省流量、載入更快）</summary>
        <ul>
          <li>進入錦標賽大廳時，聊天室先前會把整段歷史訊息一次載入，較耗流量也較慢。已改為預設只載入「最新」一頁，需要查看更早訊息時往上滑到頂端會自動續載更舊的訊息（每次一頁），讀取更快、更省流量。</li>
        </ul>
      </details>

      <details open>
        <summary><span class="ver-badge">v5.751</span> 修正：振翼髮「暗夜羽擊」未擋住對手「進化時／放置時」自動發動的特性</summary>
        <ul>
          <li>我方戰鬥場有振翼髮「暗夜羽擊」（消除對手戰鬥寶可夢特性）時，對手戰鬥場寶可夢進化（例：勇基拉→胡地）或放置時自動發動的特性（如胡地「精神抽出」抽牌）先前仍會觸發。已修正：這類「進化時／放置時」特性與一般特性一樣，會被「暗夜羽擊／初始化／監視塔／黏著束縛」等消除效果擋下（在備戰進化則不受暗夜羽擊影響，符合規則）。</li>
        </ul>
      </details>

      <details open>
        <summary><span class="ver-badge">v5.750</span> 錦標賽：瑞士制配對改用回溯法，避免不必要的重複對手</summary>
        <ul>
          <li>瑞士制每輪配對原本用貪婪法，在存在「無人重複對手」的配對方案時仍可能硬湊出重賽（成績相同、聚在名次底端的選手最常見）。已改為回溯配對：只要存在不重複的方案就一定採用，找不到才被迫最少重賽。破同分順序維持「積分 → 對手勝率(OWP) → 對手的對手勝率(OOWP)」。</li>
        </ul>
      </details>
      ...
      <details open>
        <summary><span class="ver-badge">v5.744</span> 修正：下石鳥「親送挑戰」在備戰區已滿時仍會放置寶可夢、超過上限</summary>
        <ul>
          <li>「親送挑戰」擲出 2 次正面後，先前即使備戰區已滿（5 隻，或「零之大空洞」下 8 隻）仍會從牌庫放 1 隻到備戰、導致超過上限。已修正：備戰區已滿時效果正確失敗（不放置）。</li>
        </ul>
      </details>

      <details open>
        <summary><span class="ver-badge">v5.743</span> 修正：沙河馬「推倒」強制對手交換戰鬥位後，退下的寶可夢殘留異常狀態</summary>
        <ul>
          <li>「推倒」強制對手把戰鬥寶可夢與備戰交換時，先前退回備戰的那隻寶可夢會殘留中毒／灼傷／睡眠等異常狀態。已修正：與一般撤退及其他強制交換一致，離開戰鬥場時正確解除所有特殊狀態（傷害與能量保留）。</li>
        </ul>
      </details>

      <details open>
        <summary><span class="ver-badge">v5.742</span> 修正：多種「直接進化」效果會丟失寶可夢身上多餘的道具卡</summary>
        <ul>
          <li>透過招式／特性／支援者「直接進化」時，先前部分效果會把基礎寶可夢身上「多附掛的道具卡」（透過洛托姆ex多重轉接等附掛的第 2 張以上道具）丟失，進化後也可能殘留化石標記或身份不穩。已修正：所有進化路徑統一在中央建構，正確繼承能量、道具（含多附掛）、傷害，並維持寶可夢的穩定身份。</li>
        </ul>
      </details>

      <details open>
        <summary><span class="ver-badge">v5.741</span> 修正：多種「直接進化」效果（覺醒／緊急進化／壯偉碩木／早熟進化等）進化後沒有解除異常狀態</summary>
        <ul>
          <li>透過招式、特性或支援者「直接進化」場上寶可夢的效果，先前部分會把基礎寶可夢的異常狀態（混亂／睡眠／麻痺／中毒／灼傷）帶到進化後的寶可夢。已修正：所有進化路徑統一在中央處理，進化後正確解除異常狀態（唯「暈眩山谷」在場時保留混亂，符合該卡規則）。</li>
        </ul>
      </details>

      <details open>
        <summary><span class="ver-badge">v5.740</span> 修正：寶可夢回手牌／牌庫、或被「賽吉」進化後殘留異常狀態</summary>
        <ul>
          <li>電飛鼠「天空迴旋」、土龍節節「逃跑抽出」等把自己放回手牌／牌庫的招式與特性，先前會殘留中毒／灼傷等異常狀態與部分效果，且多附掛的道具卡可能遺失。已修正：回手牌／牌庫時一律完整重置（清除全部異常狀態與效果、傷害歸零），附掛的能量與道具正確分離歸位。</li>
          <li>用支援者「賽吉」直接進化時，先前會把基礎寶可夢的異常狀態帶到進化後的寶可夢。已修正：進化會正確解除異常狀態（唯「暈眩山谷」在場時保留混亂），並保留傷害與能量。</li>
        </ul>
      </details>

      <details open>
        <summary><span class="ver-badge">v5.738</span> 修正：神奇糖果進化不解除混亂、麻痺/睡眠仍顯示撤退鈕</summary>
        <ul>
          <li>用「神奇糖果」直接進化時，先前會把基礎寶可夢的特殊狀態（混亂／睡眠／麻痺／中毒／灼傷）一起帶到進化後的寶可夢。已修正：進化會正確解除所有特殊狀態（唯「暈眩山谷」在場時仍保留混亂，符合該卡規則）。</li>
          <li>戰鬥場寶可夢處於麻痺或睡眠時，撤退按鈕先前仍會顯示（按了其實無效）。已修正：麻痺／睡眠／被招式鎖定撤退時，撤退按鈕會正確隱藏並顯示原因。</li>
        </ul>
      </details>

      <details open>
        <summary><span class="ver-badge">v5.737</span> 修正：迷唇姐「邀請之吻」補上「搬能量到新上場寶可夢」</summary>
        <ul>
          <li>「邀請之吻」卡面是「從牌庫選 1 張基礎寶可夢放備戰，然後選 1 個迷唇姐身上的能量改附於新上場的寶可夢」。先前只做了放基礎、能量搬移沒有實裝（提示請玩家手動，但實際無法手動搬）。已補上：放好基礎後會讓你從迷唇姐身上選 1 個能量，自動改附到剛放上場的那隻。</li>
        </ul>
      </details>

      <details open>
        <summary><span class="ver-badge">v5.735</span> 修正：進化寶可夢被擊倒後從棄牌區取回，導致畫面卡死</summary>
        <ul>
          <li>進化的寶可夢被擊倒後，棄牌區的進化鏈可能殘留重複的卡片識別碼；之後用「夜間擔架」「好友寶芬」等卡從棄牌區把該寶可夢取回放上場時，會與棄牌區殘留的那份衝突，造成畫面卡死、無法撤退／使用道具／結束回合（比賽中回報）。已修正：擊倒時棄牌區的進化鏈會正確攤平、不再殘留重複識別碼。</li>
        </ul>
      </details>
      ...
      <details open>
        <summary><span class="ver-badge">v5.729</span> 修正：脫殼忍者「脆弱蛻殼」只對「招式傷害」擊倒生效</summary>
        <ul>
          <li>「脆弱蛻殼」卡面是「就算受到對手寶可夢【ex】『招式的傷害』而昏厥，對手也無法獲得獎賞卡」。先前若脫殼忍者是被招式『效果』（例如放置傷害指示物、或直接使昏厥）擊倒，也誤判為對手拿不到獎賞卡。已修正：只有被 ex 的招式『傷害』擊倒才不給獎賞，被招式效果擊倒時對手正常獲得獎賞卡。</li>
        </ul>
      </details>

      <details open>
        <summary><span class="ver-badge">v5.728</span> 修正：寶可夢中心的姐姐現在能解除「全部」特殊狀態</summary>
        <ul>
          <li>「寶可夢中心的姐姐」卡面是「恢復 60 HP，特殊狀態也全部恢復」。先前若同一隻寶可夢同時陷入三種特殊狀態（例如睡眠＋中毒＋灼傷），治療後第三種（灼傷）會殘留。已修正為全部清除（此修正同時套用到所有「同時回血並解除狀態」的治療效果）。</li>
        </ul>
      </details>

      <details open>
        <summary><span class="ver-badge">v5.727</span> 修正：仙子伊布ex「魔法魅惑」的防護效果方向錯誤</summary>
        <ul>
          <li>「魔法魅惑」卡面是「在下個對手的回合，使出此招式的仙子伊布自己受到招式傷害 -100」（自身防護）。先前實作誤把效果加到對手身上（削弱對手攻擊），導致對手若使用具免疫效果的能量時，仙子伊布反而沒被保護到。已修正為正確保護自身，基礎傷害 160 不變。</li>
        </ul>
      </details>
      ...
      <details open>
        ...
        <ul>
          ...
          <li>錦標賽報名後的資訊卡，除了暱稱與牌組，現在也會顯示你選的先後攻偏好（先攻／後攻／隨機／對手決定），選完不怕忘記。</li>
        </ul>
      </details>

      <details open>
        <summary><span class="ver-badge">v5.723</span> 修正：火箭隊的監視塔在場時，月月熊赫月ex「老練招式」等【無】寶可夢特性仍生效</summary>
        <ul>
          <li>火箭隊的監視塔會消除雙方場上所有【無】寶可夢的特性，但月月熊赫月ex「老練招式」（減少「血月」的能量需求）先前在監視塔在場時仍會生效。已修正為正確被消除。整體檢查同類後，音波龍「調諧迴響」（減少「恐慌嚎鳴」能量需求）也是【無】寶可夢特性、同樣漏判，一併修正；其餘減少能量需求的招式持有者皆非【無】屬性，不受監視塔影響。</li>
        </ul>
      </details>

      <details open>
        <summary><span class="ver-badge">v5.722</span> 修正：借用招式借到「若希望」效果（如跳躍衝天回牌庫）選「否」仍被強制執行</summary>
        <ul>
          <li>呆呆王「耀閃挑戰」等借用招式時，若借到「若希望…」且效果在攻擊後才結算的招式（如蚊香泳士「跳躍衝天」選擇是否把自己放回牌庫、巨金怪「金屬之錘」丟鋼），先前即使選「否」也會被強制執行。已修正為正確尊重玩家的是/否選擇。涵蓋耀閃挑戰、揮指、技能大盜、暗黑底牌、欺詐、試著模仿、高傲指令、扮晶晶酒。</li>
        </ul>
      </details>

      <details open>
        <summary><span class="ver-badge">v5.721</span> 修正：更多借用招式（高傲指令/揮指/暗黑底牌等）借「若希望」招式也無法選不希望</summary>
        <ul>
          <li>延續上一版修正，火箭隊的貓老大ex「高傲指令」、皮可西「揮指」、N的索羅亞克ex「暗黑底牌」、技能大盜等借用其他寶可夢招式時，若借到「若希望…」的選用招式（如金屬之錘），先前同樣會被強制使用、無法選不希望。已一併修正為借任何招式都由玩家自行選擇是否使用。</li>
        </ul>
      </details>

      <details open>
        <summary><span class="ver-badge">v5.720</span> 修正：借用招式（如呆呆王耀閃挑戰）無法選「不希望」的選用效果</summary>
        <ul>
          <li>呆呆王「耀閃挑戰」、火箭隊的貓老大ex「高傲指令」等借用其他寶可夢招式時，若借到「若希望…」的選用招式（如巨金怪「金屬之錘」），先前會被強制視為「希望」，玩家無法選擇不增加傷害。已修正為由玩家自行選擇是否使用。</li>
          <li>依官方判例：選擇希望時會增加傷害，且若借用方身上有對應能量（如金屬之錘的【鋼】能量）就必須丟棄；身上沒有對應能量時，仍可選希望增加傷害。</li>
        </ul>
      </details>

      <details open>
        <summary><span class="ver-badge">v5.719</span> 修正：配樂之笛沒顯示翻開的牌（揭示同類一併補強）</summary>
        <ul>
          <li>配樂之笛將對手牌庫上方 5 張「翻到正面」時，現在會在對戰記錄公開列出翻開的全部 5 張卡名（含沒被選到的非基礎卡），玩家看得到翻到了哪些牌。基礎寶可夢仍可選任意數量放對手備戰（受備戰空位限制）。</li>
          <li>同步補強其他「翻到正面查看牌庫頂」的招式（火箭隊的貓老大ex、鐵荊棘）也公開列出翻開的卡名。</li>
        </ul>
      </details>
      ...
      <details open>
        ...
        <ul>
          ...
          <li>已修正為正確移動到所選的備戰寶可夢；同時超能妙喵的戲法舞步也從「自動選末位能量、隨機備戰」改為由玩家自行選擇要移動的能量與目標備戰。</li>
        </ul>
      </details>

      <details open>
        <summary><span class="ver-badge">v5.716</span> 修正：一般線上對戰已開始卻偶爾重新開局洗牌</summary>
        <ul>
          <li>線上對戰開局時，雙方裝置會各自洗牌建立對局，正常情況下只有一方成為正式對局。但在罕見的網路時序下，另一方「未被採用的開局」有可能蓋過已經在進行的對局，造成畫面突然回到開局、重新洗牌放寶可夢。</li>
          <li>已在狀態同步的推送端與接收端都加上防護：進行中的對局不會再被另一個開局蓋掉（雙方同意的「重新開局」功能不受影響）。</li>
        </ul>
      </details>

      <details open>
        <summary><span class="ver-badge">v5.712</span> 修正：佛烈托斯「鐵之震動」無法把【鋼】能量改附到自己的戰鬥寶可夢</summary>
        <ul>
          <li>「鐵之震動」卡面是「將自己場上的【鋼】能量以任意方式改附於自己的寶可夢身上」（含戰鬥位），但先前的能量分配介面只列出備戰寶可夢，導致從戰鬥位拆下的【鋼】能量無法再附回戰鬥位。</li>
          <li>已修正為可選自己的戰鬥寶可夢作為改附目標。</li>
        </ul>
      </details>

      <details>
        <summary><span class="ver-badge">v5.711</span> 修正：「氣旋競爭」「整隻咬」判斷對手撤退費時未計入場上增減效果</summary>
        <ul>
          <li>烈箭鷹「氣旋競爭」（對手撤退費 2 個以上時加傷）與尖牙籠「整隻咬」（對手沒有撤退費用時加傷）原本只看卡面基礎撤退費。</li>
          <li>修正為以實際撤退費判定——會把場上對撤退費的增加（如鼓擊、咒縛之炎）與減少或歸零（如磁鐵鋼能量、浮遊等特性）一併計入，與其他依撤退費計算的招式一致。</li>
        </ul>
      </details>

      <details>
        <summary><span class="ver-badge">v5.710</span> 修正：密勒頓「光子纜線」會搬走非【雷】的基本能量</summary>
        <ul>
          <li>密勒頓（M5）「光子纜線」被招式擊倒時，卡面是「選最多 2 張這隻身上的基本【雷】能量改附備戰」，但先前實作把任意屬性的基本能量都納入（沿用舊版「光子密碼」的判定）；現已修正為只認基本【雷】能量。</li>
        </ul>
      </details>

      <details>
        <summary><span class="ver-badge">v5.708</span> 修正：大舌頭「舌引」未顯示對手手牌、鐵荊棘ex「伏特旋風」不能選能量</summary>
        <ul>
          <li>大舌頭「舌引」原本自動把對手手牌前 2 張基礎寶可夢放到對手備戰、且沒讓你看到對手手牌；現已改為公開揭示對手手牌、由你選最多 2 張基礎寶可夢（比照莉莉艾的蝶結萌虻「邀請眨眼」）。</li>
          <li>鐵荊棘ex「伏特旋風」將能量改附備戰寶可夢時，原本自動選固定一張、無法挑不同屬性的能量；現已改為讓你自己選要改附哪一個能量。</li>
        </ul>
      </details>

      <details>
        <summary><span class="ver-badge">v5.707</span> 修正：手之力量等「效果擊倒」未觸發奇跡之吻／未套獎賞調整</summary>
        <ul>
          <li>胡地「手之力量」這類用『放置傷害指示物』方式擊倒對手戰鬥寶可夢時，先前不會觸發波克基斯「奇跡之吻」（擲幣多拿獎賞），也沒套用脆弱蛻殼（0張）、多餘花粉（+N）等獎賞調整。現已把這類效果擊倒統一走中央獎賞結算，與招式傷害擊倒一致（同樣修正涵蓋深淵之瞳、死亡靈魂、擊斃等所有走中央效果擊倒的招式）。</li>
        </ul>
      </details>

      <details>
        <summary><span class="ver-badge">v5.705</span> 修正：寶可夢回手牌／牌庫後可能殘留場上狀態</summary>
        <ul>
          <li>將寶可夢回收到手牌或牌庫（如天空迴旋、寶可夢旋風回收機等）時，先前可能殘留部分場上效果狀態（例如被對手降低的招式傷害、暫時免疫等）；若該寶可夢之後重新打出，這些狀態可能異常跟著回到場上。現已改用統一的「卡牌淨化」處理，回手牌／牌庫的卡一律恢復成乾淨狀態。</li>
        </ul>
      </details>

      <details>
        <summary><span class="ver-badge">v5.704</span> 修正：配樂之笛沒翻到基礎寶可夢時看不到翻開的牌</summary>
        <ul>
          <li>配樂之笛翻開對手牌庫上方 5 張時，先前若其中沒有基礎寶可夢可放，會直接洗回、你看不到翻開了哪些牌（翻對手牌庫是重要情報）。現已比照米立龍「集客」、寶可裝置3.0 的作法修正：一律顯示翻開的 5 張牌讓你看過、確認後再洗回。</li>
        </ul>
      </details>

      <details>
        <summary><span class="ver-badge">v5.702</span> 修正：白海獅「沖刷」等特性在備戰只有古舊能量時按鈕被擋</summary>
        <ul>
          <li>白海獅「沖刷」、勾帕路翁ex「金屬之路」這類「移動備戰【X】能量」的特性，先前判斷「能不能使用」時沒認得古舊能量、稜鏡能量等「視為該屬性」的特殊能量，導致備戰寶可夢身上只有這類能量時，特性按鈕被擋住無法使用（但效果本身其實認得，造成不一致）。現已修正：可用性判斷與實際效果改用同一套判定，一致認得這些特殊能量。</li>
        </ul>
      </details>

      <details>
        <summary><span class="ver-badge">v5.700</span> 修正：強制換對手戰鬥位的卡片未擋住免疫特性</summary>
        <ul>
          <li>寶可夢捕捉器、反擊捕捉器、火箭隊的坂木 將對手備戰寶可夢拉到戰鬥場時，先前未排除擁有「緊張感」（斧牙龍）、「融合為雪」（浩大鯨ex）等特性的寶可夢——這些特性卡面標明「對手從手牌使出物品卡或支援者卡時不受影響」。現已正確排除，與老大的指令、頂尖捕捉器一致。（火箭隊的坂木為支援者，另涵蓋陳舊的鰭之化石、廣域堡壘等支援者免疫。）</li>
        </ul>
      </details>

      <details>
        <summary><span class="ver-badge">v5.698</span> 修正：對戰進行中對手掛機，宣告棄權按鈕仍有時不跳出</summary>
        <ul>
          <li>強化「對手閒置宣告」的偵測：① 補上「對手需拿取獎賞卡」這一等待情境（先前在某些拿獎賞時機會誤判成「不是在等對手」而不跳按鈕，與錦標賽的判定邏輯對齊）；② 閒置倒數改成只有真的有新動作（對戰紀錄增長）時才歸零，避免畫面自動重新同步時把倒數洗掉、導致按鈕遲遲不出現。仍由你手動點擊宣告，不自動結束。</li>
        </ul>
      </details>

      <details>
        <summary><span class="ver-badge">v5.697</span> 修正：對手在開局（放置/準備）階段掛機時，宣告棄權按鈕沒跳出</summary>
        <ul>
          <li>一般線上對戰中，若對手在「放置寶可夢／按準備」的開局階段就長時間沒動作，先前不會出現「宣告對手棄權獲勝」按鈕（只在對戰進行中才偵測）。現已修正：你完成放置與準備後、對手遲遲未完成時，超過房主設定的時間就會出現宣告按鈕，仍由你手動點擊判定獲勝（保留手動宣告、不自動結束，避免雙方協議暫停時誤判）。</li>
        </ul>
      </details>

      <details>
        <summary><span class="ver-badge">v5.695</span> 修正「撤退所需能量為0／免撤退」效果未蓋過對手加撤退費</summary>
        <ul>
          <li>磁鐵【鋼】能量、小火龍「一身輕」、浮遊石類道具等「撤退所需能量為0／免撤退」效果，現在會正確蓋過對手超級水晶燈火靈ex「咒縛火焰」、阿利多斯「大網」、重力之玉、鼓擊等增加撤退費的效果（撤退費歸 0 為最後判定），與拉帝亞斯ex「天空徑線」、N的城堡一致。</li>
        </ul>
      </details>
      ...
      <details>
        <summary><span class="ver-badge">v5.691</span> 錦標賽大廳改為三分頁（賽事／排行榜／個人資料）</summary>
        <ul>
          <li>錦標賽大廳新增分頁切換：「賽事」維持原本的報名／賽程／名人堂內容；另新增「排行榜」與「個人資料」兩個分頁。排行榜（冠軍榜、勝場榜、8 強榜、決賽次數榜、社群賽主辦榜）與個人戰績統計的資料正陸續開放中。</li>
        </ul>
      </details>

      <details>
        <summary><span class="ver-badge">v5.690</span> 修正「依對手撤退所需能量造成傷害」招式改用實際撤退費</summary>
        <ul>
          <li>阿利多斯「線帶纏繞」、鐵包袱「瞬風衝激」、投摔鬼「背負上投」依對手撤退所需能量計算傷害時，現在會以「實際撤退費」計算（含咒縛火焰、重力之玉、浮遊、磁鐵能量等增減效果），與瑪夏多／長毛巨魔「影繩結」、超級水晶燈火靈ex「幻影迷宮」一致，不再只看卡面印刷的撤退費。</li>
        </ul>
      </details>

      <details>
        <summary><span class="ver-badge">v5.689</span> 修正「選對手1隻寶可夢、依自身能量數造成傷害」招式的能量計數</summary>
        <ul>
          <li>金魚王「水炮射」先前誤把自身「所有能量」都算進去，現已修正為只計算【水】能量（並正確認列古舊／稜鏡等視為水的特殊能量）。</li>
          <li>堅果啞鈴「強力鞭打」、猛雷鼓「落雷風暴」依自身能量數量造成傷害時，現在會正確以「能量單位數」計算（例如火箭隊能量算 2 個、附在進化寶可夢上的燃火能量算 3 個），不再每張只算 1。</li>
        </ul>
      </details>

      <details>
        <summary><span class="ver-badge">v5.688</span> 修正多種「依【X】能量數量增加傷害」招式的特殊能量計數</summary>
        <ul>
          <li>吼鯨王／哥達鴨「水炮」、大電海燕ex「雷電槍」、帝牙盧卡ex「金屬爆破」、椰蛋樹「木之重壓」、火炎球、瑪俐的莫魯貝可「扣殺輪」、拉普拉斯ex「水炮迴旋」、波爾凱尼恩「強力蒸汽」等「依自身【X】能量數量計算傷害」的招式，現在會正確把「當下被視為該屬性」的特殊能量也算進去（例如古舊能量、火箭隊能量、稜鏡能量、燃火能量等），不再只算基本能量。</li>
        </ul>
      </details>
      ...
      <details>
        <summary><span class="ver-badge">v5.683</span> 「依／有／丟棄某屬性能量」的招式，也正確認列特殊能量</summary>
        <ul>
          <li>電蜘蛛「麻麻羅網」、阿勃梭魯「惡棍墜落」、奇樹的霹靂電球「連鎖伏特」、泥巴魚「泥巴伏特」、紅蓮鎧騎「紅蓮引爆」等會依／看是否擁有／丟棄某屬性能量的招式，現在會把「當下被視為該屬性」的特殊能量（例如古舊能量、附在基礎寶可夢上的稜鏡能量等）一併認列，不再只認基本能量。</li>
        </ul>
      </details>

      <details>
        <summary><span class="ver-badge">v5.682</span> 移動／丟棄特定屬性能量的招式特性，正確認列特殊能量</summary>
        <ul>
          <li>白海獅「沖刷」、勾帕路翁ex「金屬之路」、佛烈托斯「鐵之震動」、阿響的熔岩蝸牛「熔岩爆炸」等「移動／丟棄某屬性能量」的效果，現在會把「當下被視為該屬性」的特殊能量也一併認列（例如古舊能量、附在基礎寶可夢上的稜鏡能量、附在 2 階寶可夢上的新衝天能量等），不再只認基本能量。</li>
        </ul>
      </details>

      <details>
        <summary><span class="ver-badge">v5.681</span> 好啦魷「惡作劇觸手」改為先看到對手牌庫頂再決定</summary>
        <ul>
          <li>好啦魷「惡作劇觸手」：卡面是「查看對手的牌庫上方 1 張卡，回復原樣，若希望重洗那個牌庫」。先前是還沒看到牌就要決定、而且會自動重洗；現在會先把對手牌庫頂那張卡顯示出來（僅該 1 張，不洩漏整副牌庫），讓你看過後再選擇是否重洗對手牌庫。</li>
        </ul>
      </details>

      <details>
        <summary><span class="ver-badge">v5.680</span> 「查看牌庫頂可丟棄」招式改為看得到牌</summary>
        <ul>
          <li>岩狗狗「挖回」、燭光靈「光照燃燒」：卡面是「查看自己的牌庫上方 1 張卡，若希望將其丟棄」。先前只跳出「是／否丟棄」的盲選、看不到那張卡；現在會把牌庫頂那張卡顯示出來讓你看過再決定丟或留（不丟則維持原樣、不重洗）。</li>
        </ul>
      </details>
      ...
      <details>
        ...
        <ul>
          ...
          <li>拉達「逆襲門牙」：現在會把「火箭隊的小拉達」身上的傷害指示物一併計入傷害計算。</li>
          <li>銀伴戰獸「空氣斬」：以效果丟棄自身的回力鏢能量後，會正確地在招式結束後重新附回銀伴戰獸（先前用 picker 選擇丟棄時不會歸還）。</li>
        </ul>
      </details>

      <details>
        <summary><span class="ver-badge">v5.677</span> 統一有效 HP 計算（修正部分卡的「效果擊倒」判定）</summary>
        <ul>
          <li>修正一個內部 HP 計算與主程式不一致的問題：怪顎龍（暴龍根性，附特殊能量時 HP +150）、化石寶可夢（固定 60 HP）、以及阻礙之塔讓道具 HP 加成失效的情況，先前在「效果直接擊倒／狙擊擊倒」等判定時會用到錯誤的 HP。</li>
          <li>影響例：以效果（非傷害）使對手昏厥的招式，先前可能無法擊倒「附特殊能量的怪顎龍」（少算 150 HP）；現已統一為與血條顯示、實際擊倒判定相同的有效 HP。</li>
        </ul>
      </details>

      <details>
        <summary><span class="ver-badge">v5.676</span> 修正依能量數量計算傷害的卡牌（火箭隊能量算 2 個）</summary>
        <ul>
          <li>吞食獸「張大嘴」：卡面是比較雙方能量「數量」。火箭隊能量視為 2 個能量，先前誤當 1 個計算，導致該 +160 傷害時沒加到，現已修正。</li>
          <li>超級捷拉奧拉ex「閃電拳」：卡面是「【雷】能量的數量 ×60」。先前誤把「全部屬性的能量張數」拿去乘，現已改為只計算【雷】能量、且火箭隊／新衝天等特殊能量依其提供的能量個數計算。</li>
        </ul>
      </details>

      <details>
        <summary><span class="ver-badge">v5.674</span> 修正危險光線被化隱誤擋＋補憨憨臉免疫</summary>
        <ul>
          <li>危險光線是道具卡，化隱／純樸只免疫「對手的招式與特性效果」，不該免疫道具效果；先前版本誤把危險光線當招式效果擋下，現已修正：被化隱的寶可夢仍會被危險光線弄成灼傷＋混亂。</li>
          <li>反向補強：擁有憨憨臉特性的寶可夢現在能正確免疫危險光線造成的混亂（只會灼傷）；泡沫【水】能量等特殊狀態免疫、祭典會場也一併套用。</li>
          <li>內部收斂：危險光線的狀態施加改走中央統一管線，狀態欄位（灼傷／混亂）放置與各種免疫判定一次到位。</li>
        </ul>
      </details>

      <details>
        <summary><span class="ver-badge">v5.673</span> 統一多目標招式的弱點/抵抗力計算</summary>
        <ul>
          <li>修正部分多目標／狙擊類招式在計算弱點與抵抗力時，沒有套用「弱點失效」「掌握弱點（弱點變更）」「妖精領域（龍系弱點變超）」以及攻擊方雙屬性（如小碎鑽＝鬥＋超）等效果——這些視窗原本用攻擊方的原始單一屬性硬比對。現在統一改用與一般攻擊相同的中央計算，結果一致。</li>
        </ul>
      </details>
<details>
        <summary><span class="ver-badge">v5.672</span> 修正退化未完整清除附加效果</summary>
        <ul>
          <li>修正寶可夢「退化」時（退化光線、奇異時鐘、太陽伊布ex 阿賽斯特萊石 等）只清除了部分狀態與效果，導致像「下個對手回合受招式增傷」「弱點變更」之類的附加效果會殘留在退化後的寶可夢身上。現在依規則（退化後特殊狀態與附加效果全部消除）統一正確全清，並保留傷害、能量、道具。</li>
        </ul>
      </details>
<details>
        <summary><span class="ver-badge">v5.671</span> 能量數傷害招式收斂計數+清重複註冊</summary>
        <ul>
          <li>延續上版能量計數修正：將「依雙方/場上能量數量造成傷害」的招式（如「萬葉陣雨」碧草面具ex）也收斂到正確的能量單位計數——火箭隊能量視為提供 2 個、燃火能量附於進化視為 3 個、繁茂的基本【草】能量視為 2 個（原本這些都被少算）。並清理了「萬葉陣雨」的重複註冊（同一招式原本在 4 個地方各寫一份）。</li>
        </ul>
      </details>
<details>
        <summary><span class="ver-badge">v5.669</span> 修能量數傷害招式對火箭隊能量計數</summary>
        <ul>
          <li>修正多張「依能量數量造成傷害」招式對特殊能量的計數：火箭隊能量視為提供 2 個能量，但原本「能量氣球（瑪力露麗ex）」把它算成 0、「大地風暴（哲爾尼亞斯）」算成 1。現依卡面「能量的數量（個）」統一正確計為 2（與「超級交響樂」一致），「能量粉碎」「耳之力」等也改以能量單位數計算。</li>
        </ul>
      </details>
<details>
...
<details>
        <summary><span class="ver-badge">v5.666</span> 統一各選擇視窗的戰鬥寶可夢標示</summary>
        <ul>
          <li>統一對戰中各選擇視窗裡「戰鬥寶可夢」的標示方式：原本選寶可夢的視窗（撤退/能量分配/傷害分配等）與選能量的視窗各自有不同寫法，現在全部統一用一致的 ⚔️ 圖示，選寶可夢的徽章收斂為單一元件（我方金色／對手紅色），避免不同視窗標示不一。</li>
        </ul>
      </details>
<details>
...
<details>
        <summary><span class="ver-badge">v5.663</span> 修正 N的謀劃 無法自選移動的能量</summary>
        <ul>
          <li>修正「N的謀劃」無法自己選擇要移動哪些能量的問題：當備戰寶可夢身上同時附有多種能量（例如同時有【惡】與【水】）時，原本系統會自動幫你選（移走最後一張），現在改為由你自己挑選要把哪些能量改附到戰鬥場（最多 2 個）。</li>
        </ul>
      </details>
<details>
        <summary><span class="ver-badge">v5.662</span> 修正特性從手牌附能未觸發對手反應</summary>
        <ul>
          <li>修正「激動渦輪（花舞鳥ex）」「無力充能（青木的樹枕尾熊）」「火焰蹈舞（烈焰猴）」「返回重載（鋼炮臂蝦）」等「從手牌附能量」的特性，原本不會觸發對手的對應反應（如耿鬼ex「侵蝕詛咒」放傷害指示物、帕奇利茲「麻痺門牙」追加傷害）。現已一律正確觸發。</li>
        </ul>
      </details>
<details>
        <summary><span class="ver-badge">v5.661</span> 漩渦言靈/熔岩地域施加狀態補齊免疫判定</summary>
        <ul>
          <li>延續上版混亂修正：將「漩渦言靈」「熔岩地域」對被換上場寶可夢施加狀態的處理，收斂到統一的上狀態管線，補齊原本遺漏的各種免疫判定。例如擁有「憨憨臉」（免疫混亂）的呆呆獸被換上場時，不會再被漩渦言靈錯誤地陷入混亂；化隱、祭典會場等免疫效果也會正確生效。</li>
        </ul>
      </details>
<details>
        <summary><span class="ver-badge">v5.660</span> 修正混亂+灼傷同時施加時混亂失效</summary>
        <ul>
          <li>修正當對手同時擁有「漩渦言靈」與「熔岩地域」時，被換上場的寶可夢同時陷入混亂與灼傷，混亂狀態卻沒有正確生效（攻擊時不會擲混亂硬幣、形同無混亂）的問題。現在混亂會正確判定。</li>
        </ul>
      </details>
<details>
        <summary><span class="ver-badge">v5.659</span> 修正三重狀態下解除灼傷誤清中毒</summary>
        <ul>
          <li>修正同時帶 3 種特殊狀態（例：睡眠＋中毒＋灼傷）時，灼傷擲幣解除會誤清掉中毒的問題：原本解除燒傷時，若燒傷位於第 3 層狀態欄，程式會錯誤地清掉第 2 層（中毒），導致中毒憑空消失、燒傷反而留著。現已修正為只清除燒傷實際所在的那一格。</li>
        </ul>
      </details>
<details>
        <summary><span class="ver-badge">v5.658</span> 修正「純樸／防護代碼」在對手回合不生效</summary>
        <ul>
          <li>修正「純樸」（骨紋巨聲鱷）與「防護代碼」（密勒頓）的防守效果原本在對手回合不生效的問題：這兩招讓自己在「下個對手回合」不受招式效果／帶「未來」標記的 ex 招式傷害，但生效時機被設在錯誤的回合（變成自己回合才生效、對手回合沒保護到）。現已修正為正確在下個對手回合生效。</li>
        </ul>
      </details>
<details>
        <summary><span class="ver-badge">v5.657</span> 修正「下個對手回合反擊」效果殘留到之後回合</summary>
        <ul>
          <li>修正「下個對手回合受招式時反擊」類效果（超級呆殼獸ex｜殼捲風旋轉、藏瑪然特｜強大猛擊、還擊斧、等待角擊 等）會殘留到之後回合的問題（與 v5.651 對減傷的修正同類）：原本使出後若對手該回合沒攻擊到它，反擊效果會一直留著、直到日後某回合被攻擊才觸發；現在只在使出後的下一個對手回合內有效，該回合結束就清除。</li>
        </ul>
      </details>
<details>
        <summary><span class="ver-badge">v5.656</span> 修正特性消除未套用到「受傷反擊型防守特性」</summary>
        <ul>
          <li>接續上一版的防守特性修正：「受傷反擊」類防守特性（布里卡隆｜尖刺盔甲、毒刺、灼熱之軀、反擊、怨恨旋渦 等）在被對手「特性消除」（振翼髮｜暗夜羽擊、初始化 等）壓制時，原本仍會對攻擊方反擊／施加異常狀態；現在這些特性被消除時會一併失效。至此防守觸發型特性（免疫、反擊、被KO觸發、減獎賞）皆已正確套用特性消除。</li>
        </ul>
      </details>
<details>
        <summary><span class="ver-badge">v5.655</span> 修正特性消除未套用到「被KO型防守特性」</summary>
        <ul>
          <li>修正部分「防守型特性」在被對手「特性消除」(如振翼髮｜暗夜羽擊、初始化)壓制時仍會錯誤生效的問題：對手在自己戰鬥場壓制特性時，被 KO 寶可夢的「被擊倒時減少對手獎賞」(脫殼忍者｜脆弱蛻殼)與「被擊倒時觸發」(願增猿ex｜鬆口氣 等)現在會一併失效。（受傷反擊類特性的同類修正將於下一版處理。）</li>
        </ul>
      </details>
<details>
        <summary><span class="ver-badge">v5.653</span> 修正激流水泵（厄鬼椪 水井面具ex）放回能量觸發備戰的條件</summary>
        <ul>
          <li>修正厄鬼椪 水井面具ex「激流水泵」觸發備戰 120 的放回能量條件：原本附「璀璨結晶」時誤把放回需求降為 2 個，導致身上有 3 個能量時只放 2 個就觸發。現依官方裁定——要放回 3 個（身上不足 3 個時放全部）才觸發備戰 120；附璀璨結晶+只有 2 個能量時放回 2 個仍可觸發（因為只有 2 個、放回全部）。璀璨結晶只減少使用招式的費用，不影響放回張數。</li>
        </ul>
      </details>
<details>
        <summary><span class="ver-badge">v5.652</span> 名人堂分「官方」與「社群自辦」兩段顯示</summary>
        <ul>
          <li>名人堂（歷屆冠軍）拆成兩段下拉：「官方歷屆冠軍」在前、預設展開直接呈現；「社群自辦歷屆冠軍」在後、預設收摺，點一下才展開。因官方賽人數多、社群自辦賽人數少（最低 4 人），奪冠難度不同，分開呈現較清楚。</li>
        </ul>
      </details>
<details>
        <summary><span class="ver-badge">v5.651</span> 修正「下個對手回合 -N」減傷殘留到之後回合</summary>
        <ul>
          <li>修正「下個對手回合受招式 -N」類效果（如蓋諾賽克特ex「防護充能」）減傷殘留的問題：原本使出後若對手該回合沒攻擊到它，減傷旗標會一直留著、直到之後某回合被攻擊才扣掉，造成「明明上回合沒出招卻還有減傷」。現在這類減傷只在使出後的下一個對手回合有效，該回合結束就清除；同類效果（變硬、躲藏、各種受招後減傷、擲幣免疫等）一併修正。</li>
        </ul>
      </details>
<details>
...
<details>
        <summary><span class="ver-badge">v5.648</span> 修正特性消除（暗夜羽擊等）未套用到「撤退費」</summary>
        <ul>
          <li>當對手「振翼髮｜暗夜羽擊」在戰鬥場壓制特性時，原本我方小火龍「一身輕」等「免撤退費」特性仍錯誤生效（不用付撤退能量）；現在撤退費計算會一併判斷持有者的特性是否被消除（暗夜羽擊／初始化／黏著束縛），被消除時免撤退費特性失效、需正常付出撤退能量。同類免撤退費特性（溶化流動／飢餓衝刺／鋼之橋／森林秘道／大網）一併收斂修正。</li>
        </ul>
      </details>
<details>
...
<details>
        ...
        <ul>
          ...
          <li>「多餘花粉」等「下個回合這隻寶可夢被擊倒時多得獎賞卡」的效果，現在無論被招式傷害、或被特性／效果（如咒詛炸彈）擊倒，都會正確多得獎賞卡。</li>
        </ul>
      </details>
...
<details>
        ...
        <ul>
          ...
          <li>全站同時只開放一場社群賽；鄰近官方賽事時段不開放發起，以官方賽事優先。名人堂中社群賽冠軍以不同顏色與「社群」標籤標示。</li>
        </ul>
      </details>
      ...
      <details>
        ...
        <ul>
          ...
          <li>手機版聊天視窗修正：訊息過多時可正常上下捲動查看歷史訊息；並可拖曳標題列移動視窗位置。</li>
        </ul>
      </details>

      <details>
        <summary><span class="ver-badge">v5.625</span> 修正：使用過特性的寶可夢被「變化之書 / 鬼之假面」換成另一隻後，換上的寶可夢特性被誤鎖</summary>
        <ul>
          <li>場上寶可夢用過特性後，用「變化之書」(或「鬼之假面」)和棄牌區寶可夢互換，換上的那隻會變成不能用特性。已依官方規則修正：換上「不同特性」的寶可夢可正常使用其特性；只有換上「相同特性」的寶可夢才維持「已使用」狀態。</li>
        </ul>
      </details>
      ...
      <details>
        ...
        <ul>
          ...
          <li>由上至下：大廳聊天室 → 進行中／即將開始的賽事 → 賽程表 → 觀戰 → 報名中的賽事 → 名人堂歷屆冠軍。</li>
        </ul>
      </details>

      <details>
        <summary><span class="ver-badge">v5.619</span> 能量分配修正：超級差不多娃娃ex「萬花筒華爾滋」等選不同屬性能量時，分配畫面會逐屬性顯示，避免附到錯的寶可夢</summary>
        <ul>
          <li>用「萬花筒華爾滋」選了不同屬性的基本能量後，分配到不同寶可夢時，畫面看不出當下在分配哪一種屬性，照選取順序填仍可能跑到錯的寶可夢身上。</li>
          <li>已改為與「過度放電」相同的分配方式：同一種屬性用「+/-」一次分配並標示【屬性】；若選了多種屬性，會「逐屬性分波」——先分配【火】、再分配【水】…每一波都清楚標示當下屬性，附到哪隻一目了然。</li>
        </ul>
      </details>

      <details>
        <summary><span class="ver-badge">v5.618</span> 錦標賽修正：對手準備完成後我方畫面沒更新（手牌沒亮）+ 自動／手動重新同步</summary>
        <ul>
          <li>錦標賽對戰中，偶爾在對手完成補抽／放置後，我方畫面沒跟著更新（手牌沒亮、不確定是否輪到自己），要重整網頁才恢復。根因是輪詢成功但漏接了對手那一步的更新、卡在舊版本。</li>
          <li>已加「自動重新同步」：對戰中只要畫面超過數秒沒更新，系統會自動向伺服器重抓最新盤面（不必手動重整），所以輪到你時畫面會自動跟上。</li>
          <li>另外在「等待對手行動」狀態列加了可點擊的「🔄 同步」（電腦版與手機版都有）；若覺得卡住，點一下即可立即重新同步。</li>
        </ul>
      </details>

      <details>
        <summary><span class="ver-badge">v5.617</span> 電腦對戰修正：百花齊放抓牌邏輯 + AI 卡住無法結束回合</summary>
        <ul>
          <li>「莉佳的蔓藤怪｜百花齊放」：電腦先前不管場上進化鏈需求，會一直抓無法進化的「莉佳的大食花」。已改為優先抓「現在用得到的」——基礎寶可夢、或進化鏈上一階已在場上／手牌的寶可夢。</li>
          <li>電腦在嘗試「無法執行的動作」時會卡住、回合結束不了，例如：「祭典樂舞」想再攻擊一次但能量已被轉移、或想打出被對手「ACE消弭」擋住的 ACE SPEC 卡（如富裕能量）。已加防呆：電腦偵測到連續無法推進時，自動結束該回合。</li>
        </ul>
      </details>

      <details>
        <summary><span class="ver-badge">v5.616</span> 對戰修正：超級沙奈朵ex「超級交響樂」沒把「火箭隊能量」算成 2 個【超】</summary>
        <ul>
          <li>「超級交響樂」的傷害是依自己場上【超】能量的數量 ×50。當「火箭隊的寶可夢」身上附有「火箭隊能量」時，依卡面該能量視為提供 2 個【超】（與【惡】），但先前系統只算 1 個，導致傷害少 50。</li>
          <li>已修正為正確計 2 個，並收斂到統一的能量計數來源，連帶讓其他依【超】／【惡】能量數計算傷害的招式也保持一致。</li>
        </ul>
      </details>

      <details>
        <summary><span class="ver-badge">v5.615</span> 對戰修正：觀戰時偶爾跑出「投降」提示、按鈕卡住</summary>
        <ul>
          <li>在手機／平板觀戰對局時，偶爾會跳出「投降」確認、所有按鈕卡住無法操作，連「離開觀戰」都按不了，要重新整理才能脫困。根因是「觀戰者」身分先前只靠座位推導，在某些畫面更新後會被誤判成參戰玩家。</li>
          <li>已改為以觀戰旗標為準，確保觀戰全程維持唯讀、不再誤出投降提示，離開觀戰按鈕也正常運作。</li>
        </ul>
      </details>

      <details>
        <summary><span class="ver-badge">v5.614</span> 對戰修正：「爆炸頭水牛」捲牆減傷——戰鬥場也依名稱計數</summary>
        <ul>
          <li>承 v5.613：當你場上有兩隻爆炸頭水牛、其中一隻是沒有「捲牆」特性的版本時，v5.613 修好了備戰位的減傷，但「戰鬥場」上的寶可夢被招式攻擊時仍沒套到 -60（玩家回報：超級袋獸ex 在激動競技場下被甲賀忍蛙ex 的忍之利刃擊倒，照理應可存活）。</li>
          <li>已將「捲牆」收斂為單一共用判定，戰鬥場與備戰位都依「場上有 2 隻以上爆炸頭水牛（依名稱計數，不要求每隻都有捲牆特性）」生效，兩處行為一致、不再分歧。</li>
        </ul>
      </details>

      <details>
        <summary><span class="ver-badge">v5.613</span> 對戰修正三則（道具觸發 / 特性減傷 / 介面）</summary>
        <ul>
          <li>沉重接力棒等「被擊倒時觸發」的道具，在被「多目標狙擊 / 分身連打」類招式擊倒戰鬥場寶可夢時沒有觸發（例如沉重接力棒沒把能量轉移到備戰）。已修正，與一般招式擊倒一致。</li>
          <li>「爆炸頭水牛」的特性『捲牆』：當你場上有兩隻爆炸頭水牛、但其中一隻是沒有『捲牆』特性的版本時，減傷沒有生效。已依卡面「場上有 2 隻以上爆炸頭水牛」依名稱計數修正（不要求每隻都有捲牆特性）。</li>
          <li>對戰中可拖曳的聊天泡泡（💬 圖示）有時會跑到畫面外消失。已加入邊界限制，確保它在拖曳、切換裝置或螢幕旋轉後都留在畫面內。</li>
        </ul>
      </details>

      <details>
        <summary><span class="ver-badge">v5.609</span> 介面修正：在部分平板／大尺寸手機以「直向」進行對戰時，「請將手機旋轉至橫向」的全螢幕提示會疊在最上層，導致對戰結束後的「返回賽事大廳」按鈕、以及觀戰時的「離開觀戰」按鈕被它蓋住、點不到（看起來像所有按鈕都失效）。已修正為：對戰結束畫面與觀戰時不再顯示該旋轉提示，讓離開／返回按鈕可正常點擊；對戰進行中仍會提示旋轉至橫向。</summary>
      </details>

<details>
        <summary><span class="ver-badge">v5.608</span> 對戰修正：支援者「越橘的一步棋」（查看牌庫頂 7 張、選 1 張【惡】寶可夢放備戰）卡面註明「無法在自己的最初回合使用」，但先前後攻玩家在自己的第一個回合卻仍可使用。根因是這張卡的限制只擋到了先攻玩家的第一回合、漏掉後攻玩家的第一回合。已修正為先攻、後攻雙方在各自的第一個回合都無法使用，第二個回合起才能使用。並整體檢查了其他標註「最初回合」限制的卡，確認判定一致正確。</summary>
      </details>

<details>
        <summary><span class="ver-badge">v5.607</span> 對戰修正：「啪咚猴」的特性『衝衝鼓』（戰鬥場有『祭典樂舞』寶可夢時，從自己的牌庫任意選擇 1 張卡加入手牌並重洗）先前發動時，畫面卻出現「不選（略過）」的選項。由於衝衝鼓是「任意」檢索、沒有限定卡片類別，只要牌庫還有牌就一定選得到，依規則不能不選。已修正為衝衝鼓必須選 1 張（牌庫為空時才不會發動）。同時整體檢查：凡卡面要求「至少選 N 張」的選擇，一律不再顯示「不選」按鈕；而「最多 N 張／任意數量」或「搜尋特定類別卡（可宣告找不到）」的選擇維持可不選，行為正確。</summary>
      </details>

<details>
        <summary><span class="ver-badge">v5.606</span> 穩定性修正：先前在極少數情況下，若對戰中出現重複的卡片識別碼，對戰畫面的卡片列表（手牌、寶可夢身上附加的卡）可能整個崩潰、跳出錯誤而白屏。已加上防呆：渲染這些列表時會自動略過重複的識別碼，讓畫面維持正常運作而不再整頁崩潰。</summary>
      </details>

<details>
        <summary><span class="ver-badge">v5.605</span> 線上對戰修正：當一方因網路延遲、畫面還沒同步到對手已經補位或行動時，先前「宣告對手棄權獲勝」可能因為看到的是舊畫面而誤判勝負。現在宣告前會以伺服器最新盤面再確認一次——只有在「確實仍輪到對手、對手真的沒有動作」時才會成立；若其實對手已經行動（只是你的畫面還沒更新），宣告會被擋下、畫面立即為你重新同步並提示「現在輪到你」，避免因畫面未同步而被誤判勝負。</summary>
      </details>

<details>
        <summary><span class="ver-badge">v5.604</span> 對戰修正：「咕咕鴿」的招式『飛翔』（擲 1 次硬幣，反面則招式失敗；正面則造成 40 傷害，並在下個對手的回合讓這隻寶可夢不會受到招式的傷害與效果）先前擲出正面後卻沒有造成任何傷害。根因是這個招式被誤併到「擲幣正面才免疫」的共用處理、傷害被寫死成 0，也沒有做「反面則招式失敗」的判定。已修正為正面確實造成 40 傷害並取得下回合免疫、反面則招式失敗，並收斂為單一「飛翔」中央處理（同步套用到「喇叭啄鳥」的飛翔）：單次擲硬幣即同時決定招式成敗與免疫，與寶可夢道具「重試徽章」的重擲硬幣也能正確配合。</summary>
      </details>

<details>
        <summary><span class="ver-badge">v5.603</span> 對戰修正：「太陽伊布ex」的招式『精神出局』（在不看正面的情況下，從對手的手牌選 1 張丟棄）先前丟棄後，沒有在對戰紀錄顯示被丟掉的是哪一張牌。由於棄牌區屬於公開資訊、雙方都應該看得到，已修正為丟棄後在對戰紀錄公開顯示被丟棄的卡名，讓雙方玩家都清楚對手手牌少了哪一張。同時整體檢查了其他「從手牌或牌庫丟棄卡」的招式與道具效果（沐淨、交易、超級能量回收、大地之容器、庫瑟洛斯奇的企圖、狂挖、插入抽出等），確認都已正確顯示丟棄的卡名。</summary>
      </details>

<details>
        <summary><span class="ver-badge">v5.602</span> 介面修正：牌組編輯器與卡牌資料庫的「進化鏈」顯示。當一隻寶可夢的名稱剛好是另一隻「不同」寶可夢名稱的開頭時（例如「咕咕」是「咕咕鴿」的開頭），原本會把不相關的進化線錯誤併在一起——「咕咕」被和「豆豆鴿」的進化線湊在一起。已修正為只認同一隻寶可夢（含其 ex／超級進化等變體），不再因名稱開頭相同而誤併；同一條進化線的前後階（如鬼斯→鬼斯通→耿鬼）仍正確完整顯示。</summary>
      </details>

<details open>
        <summary><span class="ver-badge">v5.601</span> 對戰修正：「振翼髮」的特性『暗夜羽擊』（對手戰鬥場寶可夢的特性消失）先前沒有對「大竺葵」的特性『繁茂』（自己場上有大竺葵時，自己寶可夢身上附加的基本【草】能量各視為 2 個）生效——就算大竺葵在戰鬥場被暗夜羽擊壓制，草能量仍被當 2 個來算傷害。根因是「場上是否有繁茂」的判定散落多處、且都只看名稱、沒檢查該特性是否被消除。已收斂為單一「繁茂是否有效」中央判定，會一併檢查繁茂持有者是否被暗夜羽擊、海兔獸『黏著束縛』、鐵荊棘ex『初始化』等消除；被消除時基本【草】能量回歸 1 個，且傷害計算、能量數、撤退費、攻擊費用全部一致。</summary>
      </details>

<details open>
        <summary><span class="ver-badge">v5.600</span> 新卡實裝：道具「鬼之假面」先前未實裝、打出後沒有反應、無法選棄牌區的卡。現已完整實裝——從自己的棄牌區選擇 1 張名稱中有「厄鬼椪」的寶可夢ex，與自己場上 1 隻名稱中有「厄鬼椪」的寶可夢ex 互換；所附加的卡、傷害指示物、特殊狀態與效果全部保留，被換下的寶可夢則丟棄。操作為兩段選擇：先選棄牌區要換上場的厄鬼椪ex，再選場上要被換下的厄鬼椪ex。</summary>
      </details>

<details open>
        <summary><span class="ver-badge">v5.599</span> 對戰修正：「吉雉雞」的特性『腎上腺費洛蒙』、「變隱龍」的特性『躲藏高手』（受到招式的傷害時擲 1 次硬幣，正面則不受到那個傷害；腎上腺費洛蒙還需身上附有【惡】能量）先前只有在「戰鬥場被一般招式攻擊」時才會發動。遇到多目標狙擊招式（如「酋雷姆｜三重冰霜」）、分身連打類招式、走「中央傷害結算」的招式（如「詛咒娃娃｜玩偶捕捉」），以及在「備戰區」被狙擊時，都不會擲硬幣、直接受傷。已收斂為單一「受招式傷害擲幣免傷」中央判定，讓這類擲幣免傷特性無論被哪一種招式攻擊、在戰鬥場或備戰區，都會正確擲硬幣判定。</summary>
      </details>

<details open>
        <summary><span class="ver-badge">v5.596</span> 對戰修正：「超級摔角鷹人ex」的特性『堅忍之軀』、棄世猴的『不朽身軀』（受招式傷害昏厥時擲 1 次硬幣，正面則不昏厥、以剩餘 HP 10 留在場上）先前發動時是在背景直接決定硬幣結果，沒有走正式的擲幣流程，因此看不到擲幣動畫、對戰紀錄也不會顯示擲幣，線上對戰時雙方畫面還可能不同步。現已改為正式擲硬幣，發動時會顯示擲幣動畫與紀錄，並讓線上雙方同步一致。其餘『避免昏厥』效果（皮卡丘ex『勤奮之心』、岩殿居蟹『結實』、道具『倖存鍛鍊器』）屬於「滿血才生效」的條件型、本來就不需要擲幣，維持不變。</summary>
      </details>

<details open>
        <summary><span class="ver-badge">v5.588</span> 對戰修正：「甲殼繭」的特性『增長繭』（進化時可從牌庫搜尋「甲殼繭」或「盾甲繭」放到備戰區）先前只能透過點寶可夢上的特性按鈕發動，現在改成像「鐵掌力士｜大力捕捉器」一樣，進化的當下就自動跳出「是否使用特性」的視窗。另外修正一個規則漏洞：透過『增長繭』從牌庫放到備戰區的「甲殼繭／盾甲繭」，先前可以在同一回合馬上再進化成「狩獵鳳蝶／毒粉蛾」，這違反「剛上場的寶可夢當回合不能進化」的規則，現已正確標記為剛上場、當回合無法再進化。整體檢查同類「特性／效果把寶可夢放上場」的實作，一併修正了「鐵面忍者｜脫殼」放置「脫殼忍者」也漏標記剛上場的相同問題。</summary>
      </details>

<details open>
        <summary><span class="ver-badge">v5.587</span> 線上對戰穩定性：偶爾會遇到「明明換對手行動了、畫面卻一直停著不動」的卡住情況（多半發生在雙方幾乎同時操作、本地畫面跑得比伺服器快時）。先前的自動修復只會「重新抓取」，但抓回來常被同步防護擋掉、治不了這種卡住，得手動重新整理網頁才會恢復。現在改成：若偵測到輪到對手、卻超過約 25 秒都沒有任何新動作，系統會自動以伺服器的最新狀態強制同步恢復（等於幫你按了重新整理），不必再手動重整。此自動恢復只在「正在等對手」時觸發，不會影響你自己尚未送出的操作。</summary>
      </details>

<details open>
        <summary><span class="ver-badge">v5.594</span> 對戰修正：「超級摔角鷹人ex」的特性『堅忍之軀』（這隻寶可夢因招式傷害昏厥時，擲 1 次硬幣，正面則不昏厥、以剩餘 HP 10 留在場上）先前被某些招式擊倒時不會發動。根因是這個「避免昏厥」判定原本只在主要攻擊流程結算，遇到走「中央傷害結算」或多目標狙擊／分身連打類招式擊倒時會漏掉。已收斂為單一「受招式傷害昏厥前」中央判定，讓所有『避免昏厥』效果（堅忍之軀、棄世猴的『不朽身軀』、皮卡丘ex『勤奮之心』、結實，以及道具『倖存鍛鍊器』）無論被哪種招式擊倒都正確判定；效果造成的昏厥（非招式傷害）則維持不適用。</summary>
      </details>

<details open>
        <summary><span class="ver-badge">v5.583</span> 對戰修正：「爆炸頭水牛」的特性『捲牆』（場上有 2 隻以上爆炸頭水牛時，自己的【無】基礎寶可夢受到的招式傷害 -60）屬於『特性減傷』，既不是弱點也不是抵抗力，因此就算寶可夢在備戰區、被會打到備戰區的招式（如「酋雷姆｜三重冰霜」、「甲賀忍蛙ex｜分身連打」等多目標狙擊招式）攻擊時，也應該要減傷。先前這類多目標／狙擊招式打到備戰寶可夢時，完全沒有套用防守方的特性減傷。已收斂修正——把所有打備戰傷害的路徑統一改走同一套「防守方特性／場地減傷」判定，讓捲牆、守護之鐘、齒輪塗層、凍原堡壘、岩石宮殿，以及各種自身減傷特性，無論在戰鬥場或備戰區、被一般招式或多目標狙擊招式攻擊時都正確生效。</summary>
      </details>

<details open>
        <summary><span class="ver-badge">v5.574</span> 對戰修正：競技場「夜間學院」（每個自己的回合可用 1 次，選 1 張手牌放回牌庫上方）使用後，對戰紀錄完全沒有顯示放了哪張牌，容易讓人以為效果沒生效、手牌沒放回去。其實卡片有正確移到牌庫上方，只是少了提示訊息。已補上紀錄——你本人會看到放回的卡名，對手只會看到「放回 1 張手牌」，不會洩漏你的手牌內容。</summary>
      </details>

<details open>
        <summary><span class="ver-badge">v5.573</span> 對戰修正：「沙鈴仙人掌」的特性『炸裂針』（在戰鬥場因對手招式傷害昏厥時，在攻擊方的寶可夢放置 6 個傷害指示物）先前在被某些招式擊倒時不會觸發。根因是這個反擊效果原本只在主要攻擊流程結算，遇到走「中央傷害結算」或部分特殊招式（狙擊／分配／落雷風暴等）擊倒時會漏掉。已收斂為單一「被擊倒時」中央判定，讓所有『受招式傷害昏厥才觸發』的被動效果（炸裂針，以及桃歹郎『最後鎖鏈』、願增猿ex『鬆口氣』、密勒頓『光子密碼』、沉重接力棒等）無論被哪種招式擊倒都正確觸發；效果造成的昏厥（非招式傷害）則維持不觸發。</summary>
      </details>

<details open>
        <summary><span class="ver-badge">v5.566</span> 對戰體驗（手機）：手機直式版面左上角的「離開」按鈕，先前點下去會直接離開、漏了確認視窗。現已補上——和電腦版一致，會先跳出「中離是不好的行為，訓練家應盡力完成對戰，確定要投降/離開嗎？？？」的確認，確認後才離開。</summary>
      </details>

<details open>
        <summary><span class="ver-badge">v5.565</span> 對戰修正：「帕底亞 肯泰羅｜真氣衝撞」（對手戰鬥寶可夢為【1階進化】時 +90 傷害）等『依對手／自己進化階段加成』的招式，先前對「ex／超級(Mega)」進化寶可夢判斷錯誤——因為 ex 卡的卡片類別標示為『ex』而非『Stage1／Stage2』，導致沒被認成 1 階進化而漏加。已修正：例如真氣衝撞打「超級龍頭地鼠ex」（1 階、弱火）應為 (90+90)×2＝360，先前只算 180。同時整體檢查並一併修正同類『依階段判定』的招式（奇麒麟｜中級轟鳴 等），統一改用卡片的階段欄位（ex 卡仍保留正確階段）判定。</summary>
      </details>

<details open>
        <summary><span class="ver-badge">v5.562</span> 對戰修正：當己方場上有「莉莉艾的皮皮ex」（特性『妖精領域』：使對手【龍】寶可夢的弱點變為【超】）時，用走『中央傷害結算』的招式（例如「詛咒娃娃｜玩偶捕捉」「怨影娃娃」等，特性『化隱』的寶可夢）攻擊龍系寶可夢（如多龍巴魯托ex），先前沒有套用 ×2 弱點傷害。已修正——把弱點屬性計算（含妖精領域、智揮猩『掌握弱點』、鋁鋼橋龍ex『金屬防禦強化』、小碎鑽／鐵轍跡的雙屬性）收斂為單一中央判定，引擎主管線與中央傷害結算共用同一套，避免這類招式漏算弱點。</summary>
      </details>

<details open>
        <summary><span class="ver-badge">v5.560</span> 對戰體驗：對戰畫面左上角的「離開」按鈕改名為「🏳 投降離開」，按下後會先跳出確認視窗（提醒「中離是不好的行為，訓練家應盡力完成對戰」），確認後才會離開，減少不小心或順手中離影響對手。對手中途離開時，獲勝方畫面的訊息也改為「對手承認技不如人，先行離開了」。</summary>
      </details>

<details open>
        <summary><span class="ver-badge">v5.557</span> 對戰修正：「棄世猴｜同命戰鬥」（雙方戰鬥寶可夢一起昏厥）等『以招式效果直接使對手昏厥』的招式，先前在擊倒『附有古舊能量』的寶可夢時，會錯誤地少給對手 1 張獎賞卡（變成 0 張）。已修正——古舊能量「少給 1 張獎賞」依官方卡面只在『受到招式的傷害而昏厥』時生效，這類『效果昏厥』不適用，應正常給獎賞。同時整體檢查並一併修正同類『以效果強制昏厥』的招式（雙斧戰龍｜斧擊在地、轟鳴月ex｜瘋癲攻擊、冰伊布ex｜藍柱石），統一改走「效果昏厥不套用傷害昏厥才生效的獎賞調整」。</summary>
        <ul>
          <li>同理，「莉莉艾的珍珠（-1）」「豪華斗篷（+1）」「超級耿鬼ex｜影藏（-1）」等『受到招式傷害昏厥才生效』的獎賞調整，這些效果昏厥招式也一律不套用。</li>
        </ul>
      </details>

<details open>
        <summary><span class="ver-badge">v5.555</span> 對戰修正：「耿鬼ex｜戲法舞步」「超能妙喵｜戲法舞步」「高傲雉雞｜反轉之風」這類『移動／放回對手戰鬥寶可夢身上能量』的招式效果，先前對「附有『硬岩【鬥】能量』『薄霧能量』、或具有『純樸』『化隱』等不受對手招式效果影響的對手戰鬥寶可夢」仍會生效。已修正——這類搬移能量屬於『招式的效果』，對受招式效果免疫的對手戰鬥寶可夢不再生效（傷害照常）。（將此類招式效果統一收斂到既有的招式效果免疫中央判定，避免各自漏算。）</summary>
        <ul>
          <li>根因：戲法舞步類效果以彈出選單方式搬移能量，發動前沒有經過招式效果免疫的中央判定。</li>
          <li>收斂：新增單一中央閘門，所有『動對手戰鬥位能量／狀態』的招式效果發動前都先檢查免疫來源。</li>
        </ul>
      </details>

<details>
        <summary><span class="ver-badge">v5.548</span> 對戰修正：「布里卡隆｜尖刺盔甲」等『受到招式傷害時反擊對方』的特性，先前在持有者『被該招式擊倒』時不會觸發反傷（被擊倒就漏算，老問題）。已修正——依官方規則，這類反擊在持有者被擊倒時仍會對使用招式的寶可夢造成傷害。同時整體檢查並一併修正同類『需讀取自身能量數／自身是否在場』的受傷反擊特性（怨恨旋渦、快掃拳返），統一改用『受傷前的快照』判定，被擊倒時也能正確結算反傷。</summary>
      </details>

<details>
        <summary><span class="ver-badge">v5.544</span> 對戰修正：「狙擊型／延後傷害型」招式（例如打到對手戰鬥場的延後傷害招式）先前沒有套用對手的「防守方減傷」效果，導致對手該減的傷害沒減。已修正——這類招式現在會和一般攻擊一樣，正確套用「鐵之防禦強化」「全金屬實驗室」「青銅鐘｜守護之鐘」「齒輪怪｜齒輪塗層」「蓋諾賽克特ex｜防護充能（下次被擊減傷）」「果實道具」「冰雪巨龍｜凍原堡壘」等所有防守方減傷。（內部把防守方減傷收斂為單一中央函式，引擎主管線與狙擊／延後型招式共用，避免再各自漏算。）</summary>
      </details>

<details>
        <summary><span class="ver-badge">v5.543</span> 對戰修正：「多龍奇｜偵查指令」「探險家的嚮導」「辛俐」這類『查看牌庫上方數張卡、強制選擇指定張數加入手牌』的效果，先前錯誤地多顯示了【不選】按鈕。已修正——這類『看到牌之後必須選擇』的牌庫效果不再出現【不選】，必須選滿規定張數。（注意：「搜尋牌庫找出特定卡」的效果，依官方規則即使牌庫中有也可選擇「找不到」，因此仍保留【不選】。）</summary>
      </details>

<details>
        <summary><span class="ver-badge">v5.541</span> 對戰修正：「青木的土龍節節ex｜職務猛攻」（擲與這隻寶可夢身上附加的能量的數量相同次數的硬幣）先前是按「能量卡張數」計算，沒有把特殊能量實際提供的能量數算進去——例如「燃火能量」附於進化寶可夢時視為提供 3 個能量、「火箭隊能量」視為 2 個，原本都只算 1 次。已修正為依官方「能量的數量」計算。同時整體檢查並一併修正所有「依附加能量數計算傷害／擲幣次數」的招式（光電傘蜥｜強大伏特、大劍鬼｜能量斬、雙刃丸｜能量硬殼、以歐路普／大宇怪｜精神強念、代歐奇希斯｜精神尖槍 等），統一改用同一套能量單位計算。</summary>
      </details>

<details>
        <summary><span class="ver-badge">v5.540</span> 對戰修正：我方有「耿鬼ex｜侵蝕詛咒」在場時，先前只有對手『手動附加能量』才會在那隻寶可夢身上放置 2 個傷害指示物；對手若改用『特性或招式從手牌附加能量』（例如「厄鬼椪 碧草面具ex｜碧綠之舞」「固拉多｜充溢之力」「卡比獸｜吃飽先」「葉伊布｜嫩葉之恩」「熟成充能」「岩石武裝」等）則沒有觸發。已把所有『從手牌附加能量』的路徑收斂到同一處理，現都會正確觸發侵蝕詛咒（同時一併涵蓋「帕奇利茲｜麻痺門牙」等同類「對手附能時觸發」的被動特性）。</summary>
      </details>

<details>
        <summary><span class="ver-badge">v5.538</span> 對戰修正：使用「鐵之防禦強化」後，下個對手回合自己的【鋼】寶可夢受招式傷害 -30 的效果，先前完全沒有生效（內部旗標在錯誤的回合套用）。已修正——現在會正確在對手回合生效，並能與「全金屬實驗室」「蓋諾賽克特ex｜防護充能」等其他減傷正確疊加（例如三者同時可達 -90）。</summary>
      </details>
...
<details>
        <summary><span class="ver-badge">v5.534</span> 對戰修正：使用「甲賀忍蛙ex｜忍之利刃」「詛咒娃娃｜玩偶捕捉」「貓頭夜鷹｜鉤爪搜尋」這類『造成傷害＋若希望從牌庫搜尋卡加入手牌』的招式時，若擊倒對手，原本會先拿獎賞卡、才跳出牌庫搜尋視窗。已修正為：先進行牌庫搜尋、選完卡後才造成傷害並拿獎賞卡（與「螺旋俯衝」的順序一致）。</summary>
      </details>
