    ...
    try {
      ...
      const _roomsCombinedMw = async (req, res, next) => {
        try {
          ...
          return res.status(200).json({ rooms: _rooms, combined: true, h: _dg });
