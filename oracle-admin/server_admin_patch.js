      ...
      try {
        ...
        for (const r of rttRows) {
          try {
            ...
            if (rt && typeof rt.p95 === 'number') p95s.push({ ts: r.ts, email: r.email || null, p50: rt.p50, p95: rt.p95, max: rt.max, n: rt.n });
