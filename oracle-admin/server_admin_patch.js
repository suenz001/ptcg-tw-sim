...
import('firebase-admin').then(async ({ default: admin }) => {
  ...
  (function registerStatsEndpoints() {
    ...
    app.locals._deckRuleHelpers = { getCardNameMap, deckToSets, deckMatchesRule, classifyDeck };
