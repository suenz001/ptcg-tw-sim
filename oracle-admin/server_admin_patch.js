      ...
      try {
        if (regs.length) {
          ...
          if (_liveIds.length) {
            ...
            const _theirMatches = await TMATCH.find({ eventId: { $in: _liveIds }, $or: [{ p1uid: { $in: _myUids } }, { p2uid: { $in: _myUids } }] }, { projection: { p1uid: 1, p2uid: 1 } }).toArray();
