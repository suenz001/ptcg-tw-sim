...
(async () => {
  try {
    ...
    app.get('/api/friends/list', async (req, res) => {
      try {
        ...
        for (const d of docs) {
          ...
          const _ln = latest.get(d.a === me.email ? d.b : d.a);
          if (_ln) p.nick = _ln;
    ...
    console.log('[friends] endpoints registered (v1.41) enabled-by-default=false');
