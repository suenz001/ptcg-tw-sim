...
import { oppStatusPost } from '../_shared';
import { regPost } from '../_shared';
regPre('叉字蝠|毒音波', (state, aIdx, pool) => ({ state, damage: 80 }));
regPost('叉字蝠|毒音波', oppStatusPost('poisoned', 'confused', '毒音波'));
...
fs.writeFileSync('src/lib/game/effects/cards/v2306_meta_pokemon.ts', parts.join('\\n'), 'utf8');
