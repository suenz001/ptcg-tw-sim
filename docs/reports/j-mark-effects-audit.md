...
Generated: 2026-05-04T07:45:43.272Z
...
| P1 | M4 | 18437 | 章魚桶 | Attack | 墨汁噴射 | coin-flip | 30 在下個對手的回合，受到這個招式的寶可夢使用招式時，對手擲2次硬幣。只要出現1次反面，則那個招式失敗。 |
...
| P3 | M4 | 18449 | 電龍 | Attack | 閃光伏特 | cross-turn-effect | 140 在下個自己的回合，這隻寶可夢無法使用「閃光伏特」。 |
| P2 | M4 | 18450 | 電飛鼠 | Attack | 天空迴旋 | hand-op | 30 將這隻寶可夢與附加的卡，全部放回手牌。 |
| P2 | M4 | 18451 | 代歐奇希斯 | Attack | 基因充能 | deck-search-or-deck-op | 從自己的牌庫選擇最多2張「基本【超】能量」卡，附於這隻寶可夢身上。並且重洗牌庫。 |
| P3 | M4 | 18453 | 代歐奇希斯 | Attack | 精神防護 | cross-turn-effect | 80 在下個對手的回合，這隻寶可夢不會受到擁有特性的寶可夢招式的傷害。 |
| P2 | M4 | 18454 | 代歐奇希斯 | Attack | 精神高速 | deck-search-or-deck-op | 30 若希望，從牌庫抽卡直到自己的手牌滿5張為止。 |
...
| P1 | M4 | 18487 | 肯泰羅 | Attack | 群起瞄準 | coin-flip | 選擇1隻對手的寶可夢，擲與自己的場上的，名稱中有「肯泰羅」的寶可夢的數量相同次數的硬幣。所選的寶可夢受到正面出現的次數×50點傷害。[在備戰區不計算弱點・抵抗力。] |
| P3 | M4 | 18488 | 探探鼠 | Ability | 監視之眼 | field-passive | 只要這隻寶可夢在場上，雙方的所有寶可夢身上放置的傷害指示物，無法改放於其他寶可夢身上。 |
| P1 | M4 | 18489 | 步哨鼠 | Attack | 臨檢 | coin-flip | 擲3次硬幣。若出現正面，則查看對手的手牌，從其中選擇與正面出現的次數相同數量的卡，放回對手的牌庫並重洗。 |
...
| P1 | 083 | 18531 | 肯泰羅 | Attack | 群起瞄準 | coin-flip | 選擇1隻對手的寶可夢，擲與自己的場上的，名稱中有「肯泰羅」的寶可夢的數量相同次數的硬幣。所選的寶可夢受到正面出現的次數×50點傷害。[在備戰區不計算弱點・抵抗力。] |
| P1 | 083 | 18532 | 步哨鼠 | Attack | 臨檢 | coin-flip | 擲3次硬幣。若出現正面，則查看對手的手牌，從其中選擇與正面出現的次數相同數量的卡，放回對手的牌庫並重洗。 |
