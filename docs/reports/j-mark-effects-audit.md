...
Generated: 2026-05-04T01:08:58.715Z
...
| P1 | M-P-J | 18063 | 波爾凱尼恩 | Attack | 強力蒸汽 | coin-flip | 90× 擲與這隻寶可夢身上附加的【水】能量的數量相同次數的硬幣，造成正面出現的次數×90點傷害。 |
...
| P1 | M3 | 18001 | 波爾凱尼恩 | Attack | 強力蒸汽 | coin-flip | 90× 擲與這隻寶可夢身上附加的【水】能量的數量相同次數的硬幣，造成正面出現的次數×90點傷害。 |
| P4 | M3 | 18003 | 勒克貓 | Ability | 鬥志戰吼 | ability-other | 若對手的戰鬥寶可夢為「寶可夢【ex】」，則這隻寶可夢就算在自己的最初回合或者剛使出的回合，也可進化。 |
| P1 | M3 | 18004 | 倫琴貓 | Attack | 猛力進攻 | variable-damage | 70× 造成自己已經獲得的獎賞卡的張數×70點傷害。 |
...
| P1 | M3 | 18020 | 寶寶暴龍 | Attack | 勃然大怒 | variable-damage | 20× 造成這隻寶可夢身上放置的傷害指示物的數量×20點傷害。 |
...
| P1 | M3 | 18022 | 摔角鷹人 | Attack | 復仇踢 | variable-damage | 30+ 若自己的備戰寶可夢身上放置有傷害指示物，則增加60點傷害。 |
...
| P1 | M3 | 18026 | 耿鬼 | Attack | 意志劫持 | variable-damage | 10+ 增加對手的備戰寶可夢的數量×30點傷害。 |
...
| P1 | M3 | 18030 | 古劍豹 | Attack | 上升利刃 | variable-damage | 80+ 若對手的戰鬥寶可夢為「寶可夢【ex】」，則增加80點傷害。 |
...
| P1 | M3 | 18392 | 寶寶暴龍 | Attack | 勃然大怒 | variable-damage | 20× 造成這隻寶可夢身上放置的傷害指示物的數量×20點傷害。 |
