...
if (!hasBaseCommit(ROOT, BASE)) {
  ...
  if (chk('F0 BASE 樹重建成功（整個 src/ 子樹）', r.ok, r.reason ?? ('replaced=' + r.replaced + ' removed=' + r.removed))) {
    ...
    const _v6376Strip = (src) => {
      ...
      let t = _v6376StripBlocks(stripV6408Engine(stripV6410Engine(stripV6413Engine(stripV6414Engine(stripV6418Engine(stripV6419Engine(stripV6420Engine(stripV6421Engine(stripV6422Engine(stripV6427Engine(src)))))))))), 'v6376-');
