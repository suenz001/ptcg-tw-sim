...
const TOURN_SHA = 'ebee9891421e33226965ee1afe63fb22878f433939b5771b355a8e5ace926dd8';
const TOURN_LEN = 234650;   // ⭐v6.365 重釘（站長裁定 六-2：錦標賽平手＝雙敗，區塊加長 3050 字元（舊值不寫在這裡：守衛要求舊值零殘留））
