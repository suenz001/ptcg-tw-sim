...
const TOURN_SHA = '7f5399c428aaae7e87ad849b6868d13211b0020df9ba36f7272948741be3d5a8';
const TOURN_LEN = 224269;   // ⭐v6.365 重釘（站長裁定 六-2：錦標賽平手＝雙敗，區塊加長 3050 字元（舊值不寫在這裡：守衛要求舊值零殘留））
