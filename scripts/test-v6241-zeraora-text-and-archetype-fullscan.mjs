...
await T('【A】⑨ 校驗和：卡片總數與各卡包張數與 v6.240 完全相同（只改一個字串，沒有搬動資料）', () => {
  const EXPECT = {"M-P-H":11,"M-P-I":51,"M-P-J":135,"M1L":92,"M1S":92,"M2":116,"M2a":486,"M3":117,"M4":120,
  ...
  // ⭐ v6.391（Rule 40 第三次）：M-P-J 由 103 → 135 —— 官方 M-P 特典卡現查 195 張，站上只收了 165 張，
  //   本版把差集 32 張（id 19668-19670／19720-19748，全 J 標）補齊。**只 append，既有 103 筆逐字未動**，
  //   那一點由 test-v6391 的 E4（拿 BASE blob 逐字比對）守著，不是靠這張快照表。
