...
const PREV_SHA = 'eee32db24edc871fb4ef5c87d043250e19aeea81';   // v6.347（v6.348 的上一版）
...
// v6.348 弱點覆寫跨回合時序修正（掌握弱點／覆蓋伏特）＋ 治癒類四張卡收斂
const PREV_ALLOWED = [
  'src/lib/game/effects/_shared.ts',
  'src/lib/game/effects/cards/m6a_wave7.ts',
  'src/lib/game/effects/cards/v2995_g4_wave1.ts',
