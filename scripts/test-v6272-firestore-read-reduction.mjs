...
const PREV_SHA = '4a4865447a72d5aa056e9025009928d2769eedab';   // v6.345（v6.346 的上一版）
...
// v6.346 M6a 招式實裝 批次6（防禦旗標／全體傷害／指示物 15 招，招式最後一批）
const PREV_ALLOWED = [
  'src/lib/game/effects.ts',
  'src/lib/game/effects/cards/m6a_wave6.ts',
