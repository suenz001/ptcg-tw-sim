...
const PREV_SHA = 'b9221fb920df320d74d74a67572f24b4f14d9f8c';   // v6.343（v6.344 的上一版）
...
// v6.344 M6a 招式實裝 批次4（換位／退化／道具 8 招）＋ 退化第二份實作收斂到中央
const PREV_ALLOWED = [
  'src/lib/game/effects.ts',
  'src/lib/game/effects/cards/m6a_wave4.ts',
