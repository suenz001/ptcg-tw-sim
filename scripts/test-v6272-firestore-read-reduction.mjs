...
const PREV_SHA = '3847043d140de95d88f73f78cb485ad8e6989669';   // v6.346（v6.347 的上一版）
...
// v6.347 M6a **特性**實裝 批次7（11 個特性；M6a 最後一批）
const PREV_ALLOWED = [
  'src/lib/game/effects.ts',
  'src/lib/game/effects/cards/m6a_wave7.ts',
  'src/lib/game/effects/cards/v3060_deferred_wave_b.ts',
