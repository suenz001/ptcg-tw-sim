...
const PREV_SHA = '9053c10c18218b96dee426ea5deccc8627f74138';   // v6.349（v6.350 的上一版）
...
// v6.350 印刷閘（皮卡丘ex｜十萬伏特）＋ per-attack 使用前提（賽富豪｜歡慶）
const PREV_ALLOWED = [
  'src/lib/game/effects.ts',
  'src/lib/game/effects/_shared.ts',
  'src/lib/game/effects/cards/m6a_wave3.ts',
